...
public class MainClass 
{
	...
	public static void main(String[] args)
	{
		...
		{
			displayFinalReport(mySodOrder.getItemNames(), mySodOrder.getItemCount(), mySodOrder.getDiscountNames(), mySodOrder.getDiscountCount(),mySodOrder.getPrizeNames(), mySodOrder.getPrizeCount());
		}
	...
	public static void displayFinalReport(String[] borrowedItemName, int[] borrowedItemCount, String[] borrowedDiscountName, int[] borrowedDiscountCount, String[] borrowedPrizeName, int[] borrowedPrizeCount)
	{
		System.out.println("~~~~~ ~~~~~~ ~~~~~ ~~~~ ~~~~ ~~~~~~");
		System.out.println("ORDER REPORT");
		System.out.println("~~~~~ ~~~~~~ ~~~~~ ~~~~ ~~~~ ~~~~~~");
