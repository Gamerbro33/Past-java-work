...
public class SodOrder 
{
	...
	private int[] prizeCount = new int[PRIZE_NAMES.length];
	...
	public void setItemName()
	{
		if(itemCount == null)
		{
			itemCount = new int[ITEM_NAMES.length];
		}
		if(itemSelection=='A')
		{
	...
	public void setPrizeName()
	{
		...
		if(prizeCount == null)
		{
			prizeCount = new int[PRIZE_NAMES.length];
		}
		localIndex = getRandomNumber();
		prizeName.equals(PRIZE_NAMES[localIndex]);
		prizeCount[localIndex]++;
